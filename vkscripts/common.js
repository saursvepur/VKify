...
function psr(html) {
  ...
  html = html.replace(/https:\/\/web.archive.org\/web\/20140421123306\/http:\/\/cs(\d+)\.(userapi\.com|vk\.com|vk\.me|vkontakte\.ru)\/c(\d+)\/(v\d+\/|[a-z0-9\/_:\-]+\.jpg)/gi, 'https://web.archive.org/web/20140421123306/https://pp.vk.me/c$3/$4');
  html = html.replace(/https:\/\/web.archive.org\/web\/20140421123306\/http:\/\/cs(\d+)\.(userapi\.com|vk\.com|vk\.me|vkontakte\.ru)\/([a-z0-9\/_:\-]+\.jpg)/gi, 'https://web.archive.org/web/20140421123306/https://pp.vk.me/c$1/$3');
  html = html.replace(/https:\/\/web.archive.org\/web\/20140421123306\/http:\/\/cs(\d+)\.(userapi\.com|vk\.com|vk\.me|vkontakte\.ru)\//gi, 'https://web.archive.org/web/20140421123306/https://ps.vk.me/c$1/');
  html = html.replace(/https:\/\/web.archive.org\/web\/20140421123306\/http:\/\/video(\d+)\.vkadre\.ru\//gi, 'https://web.archive.org/web/20140421123306/https://ps.vk.me/v$1/');
  return html;
}
...
var stManager = {
  ...
  _srcPrefix: function (f, v) {
    ...
    if (f.indexOf('.css') != -1) {
      return 'https://web.archive.org/web/20140421123306/http://st0.vk.me';
    }
    ...
    return 'https://web.archive.org/web/20140421123306/http://st' + ((src % vk.stDomains) + 1) + '.vk.me';
  },
  _add: function(f, old) {
...
function updateOtherCounters(url, referrer) {
  ...
  vkImage().src = locProtocol + '//web.archive.org/web/20140421123306/http://counter.yadro.ru/hit?r' + escape(referrer) + (window.screen === undefined ? '' : ';s' + screen.width + '*' + screen.height + '*' + (screen.colorDepth ? screen.colorDepth : screen.pixelDepth)) + ';u' + escape(url) + ';' + Math.random() + '';
...
function handlePageParams(params) {
  ...
  if (mv) {
    mv.firstChild.href = params.mvklnk || 'https://web.archive.org/web/20140421123306/http://m.vk.com/';
  }
  if (confMail) {
    if (!params.nomail) {
